...
def seed_everything(seed = None, workers: bool = False) -> int:
    ...
    Args:
        ...
        workers: if set to ``True``, will properly configure all dataloaders passed to
            the Trainer with a ``worker_init_fn``. If the user already provides such a
            function for their dataloaders, setting this argument will have no influence
            See also: :func:`~pytorch_lightning.utilities.seed.pl_worker_init_function`.
    From pytorch-lightning seed_everything
    """
